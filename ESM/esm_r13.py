...
Based on ESM_r12 (originally generated by Colab,
...
[r13] 기울기(Slope) 분산 원인 진단을 위한 세분화 분석 추가:
  ...
  - 아직 어느 쪽이 결과를 더 잘 설명하는지 결론이 나지 않아, 사용자가 두 가지 시각화/표를 보고
    하나를 채택하거나 더 세분화할지 판단할 수 있도록 양쪽 모두 제공.
"""
...
class ESAnalyzerApp(AppDashboard):
    ...
    def _render_learning_plots(self, hw_df, pooled_active_points):
