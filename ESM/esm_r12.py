...
Based on ESM_r11 (originally generated by Colab,
https://colab.research.google.com/drive/1z-2MrlWJjp_vs8s7Zv_kFStx7XyqcFXK).

[r12] Learning Energy Curve 탭 전면 개편:
  - 입력을 CM(Cell-RU Mapping) + 단일 통합 학습데이터 CSV(Consumed Power / CellUnavailableTimeDown /
    UsedRB, UsedRB_t, nRB) 2개로 단순화하고 드래그 앤 드롭 입력을 지원.
